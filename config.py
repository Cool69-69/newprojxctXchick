...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5729483803:AAHP02hjTCHH4xUagTtb3poaYmTnSnKlOg4")
...
DB_NAME = os.environ.get("DATABASE_NAME", "heavenx")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "890230886 1154404230 1921088773 1612173220 1120465309 1268492137 930859384 1994336709").split()):
        ADMINS.append(int(x))
except ValueError:
